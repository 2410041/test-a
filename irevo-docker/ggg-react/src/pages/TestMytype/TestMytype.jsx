...
export default function Mytype() {
    ...
    // 診断テストの全質問（カテゴリごとに10問ずつ）
    const questions = [
        // Logical (論理的・理性的)
        { text: "判断の際は感情よりもデータや事実を重視する。", category: "Logical" },
        { text: "問題を分析してから行動する。", category: "Logical" },
        { text: "論理的な議論が得意だ。", category: "Logical" },
        { text: "直感よりも根拠を重視する。", category: "Logical" },
        { text: "感情的な判断をすることが多い。", category: "Logical", reverse: true },
        { text: "感覚よりも理屈で説明したいタイプだ。", category: "Logical" },
        { text: "客観的に物事を見られる。", category: "Logical" },
        { text: "論理的な説明がないと納得しにくい。", category: "Logical" },
        { text: "人の意見よりも自分の分析を信じる。", category: "Logical" },
        { text: "感情を表に出すのは苦手だ。", category: "Logical" },

        // Organized (計画的・堅実的)
        { text: "計画を立てて行動するのが好きだ。", category: "Organized" },
        { text: "スケジュール管理は得意なほうだ。", category: "Organized" },
        { text: "予定変更はあまり好きではない。", category: "Organized" },
        { text: "物事を順序立てて考える。", category: "Organized" },
        { text: "行き当たりばったりで動くことが多い。", category: "Organized", reverse: true },
        { text: "整理整頓は得意だ。", category: "Organized" },
        { text: "計画に沿って進めると安心する。", category: "Organized" },
        { text: "時間に正確だと言われる。", category: "Organized" },
        { text: "予定を立てずに行動することが多い。", category: "Organized", reverse: true },
        { text: "効率的に作業を進めることを意識している。", category: "Organized" },

        // Friendly (交友的・感覚的)
        { text: "初対面の人ともすぐに打ち解けられる。", category: "Friendly" },
        { text: "人の話を聞くのが好きだ。", category: "Friendly" },
        { text: "周囲の雰囲気をよく見るほうだ。", category: "Friendly" },
        { text: "チームで働くのが好きだ。", category: "Friendly" },
        { text: "一人で行動するのが好きだ。", category: "Friendly", reverse: true },
        { text: "人に喜んでもらうと嬉しい。", category: "Friendly" },
        { text: "友人が多いほうだ。", category: "Friendly" },
        { text: "周りの意見を尊重する。", category: "Friendly" },
        { text: "人と話すのは疲れると感じる。", category: "Friendly", reverse: true },
        { text: "感情を表に出すタイプだ。", category: "Friendly" },

        // Creative (冒険的・独創的)
        { text: "新しいアイデアを考えるのが好きだ。", category: "Creative" },
        { text: "ルールよりも柔軟性を大切にする。", category: "Creative" },
        { text: "人と違うことをするのが好きだ。", category: "Creative" },
        { text: "新しい挑戦にワクワクする。", category: "Creative" },
        { text: "安定よりも変化を好む。", category: "Creative" },
        { text: "リスクを恐れず行動できる。", category: "Creative" },
        { text: "既存のやり方に疑問を持つ。", category: "Creative" },
        { text: "失敗しても新しい挑戦を続けたい。", category: "Creative" },
        ...
        { text: "他人よりも優れていたいと感じる。", category: "Competitive" },
        { text: "勝負ごとに燃えるタイプだ。", category: "Competitive" },
        { text: "結果にこだわるほうだ。", category: "Competitive" },
        { text: "競うよりも協力したい。", category: "Competitive", reverse: true },
        { text: "負けず嫌いだ。", category: "Competitive" },
        { text: "達成感がモチベーションになる。", category: "Competitive" },
        { text: "プレッシャーがあると力を発揮する。", category: "Competitive" },
        { text: "ライバルがいるとやる気が出る。", category: "Competitive" },
        { text: "勝ち負けにはこだわらない。", category: "Competitive", reverse: true }
    ];
    ...
    const handleAnswer = (value) => {
        ...
        setScores((prev) => {
            const updated = { ...prev, [question.category]: prev[question.category] + scoreValue };
            return updated;
        });
            ...
            <div className='body'>
                ...
                <div className="container2">
                    ...
                    {!showChart && (
                        <>
                            {/* 質問番号表示 */}
                            <div className="question-number">{`${currentQuestion + 1} / ${questions.length}`}</div>
                            {/* 質問文 */}
                            ...
                            <div className="progress-text">
                                進捗：{Math.round((currentQuestion / questions.length) * 100)}%
                            </div>
                        </>
                    )}
                    {/* 診断結果画面 */}
